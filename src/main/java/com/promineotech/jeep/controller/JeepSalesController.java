...
public interface JeepSalesController {
  ...
  @Operation(
      ...
      responses = {
          @ApiResponse(
              responseCode = "200", //HTTP Response 200 means OK
              description ="A list of jeeps is returned", 
              content  = @Content(
                  mediaType ="application/json", 
                  schema = @Schema(implementation = Jeep.class))), 
          @ApiResponse(
              responseCode = "400", //bad input
              description ="The reauest parameter is invalid", 
              content  = @Content(mediaType ="application/json")), 
          @ApiResponse(
              responseCode = "404", //not found
              description ="No jeeps were found in the input citeria", 
              content  = @Content(mediaType ="application/json")), 
          @ApiResponse(
